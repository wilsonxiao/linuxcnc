...
/*
without PyErr_Print
PYUSABLE=1 (taskclass.cc) _task=1

PROBLEM taskclass.cc TASK_VAR is string <pytask>
...
*/
    ...
    fprintf(stderr,"PY3_WORKAROUND in handle_pyerror() fake msg\n");
    std::string msg = "<this is workaround msg for handle_pyerror()>";
    return msg;
    //avoid broken stuff below
#else
