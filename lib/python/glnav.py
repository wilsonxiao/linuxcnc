...
def use_pango_font(font, start, count, will_call_prepost=False):
    ...
    w=font_bitmaps.width   # PY3 hack for font_bitmaps
    h=font_bitmaps.height  # PY3 hack for font_bitmaps
    d=font_bitmaps.descent # PY3 hack for font_bitmaps
    DIM=font_bitmaps.DIM   # was 256, typ here is 32
    ...
    try: #PY3hack
        ...
        print("\nPY3 glnav.py:use_pango_font(): missing pango/cairo features\n"
                "    using hardcoded bitmaps,w=%d h+d=%d\n"%(w,h+d))
        return base, w, h+d # PY3 guess
